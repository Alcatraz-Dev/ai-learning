...
export function HomeFloatingNav() {
    const navItems = [
        ...
        },
        {
            name: "About",
            link: "#about",
            icon: <IconLayout2 className="h-4 w-4 text-white"/>,
        },

        {
            name: "Showcase",
            link: "#showcase",
            icon: <IconBrandYoutube className="h-4 w-4 text-white"/>
        },
        {
            name: "Testimonials",
            link: "#testimonials",
            icon: <IconPencilCheck className="h-4 w-4 text-white"/>
        },
        {
            name: "How it works",
            link: "#how-it-works",
            icon: <IconTableShortcut className="h-4 w-4 text-white"/>
        },  {
            name: "Pricing",
            link: "#pricing",
            icon: <IconReceipt2 className="h-4 w-4 text-white"/>
        },
        {
            name: "Contact",
            link: "#contact",
            ...
            >
                ...
                <Link href={'/sing-in'}>
                    <button
                        ...
                        <span>Login</span>
                        <span
                            className="absolute inset-x-0 w-1/2 mx-auto -bottom-px bg-gradient-to-r from-transparent via-purple-500 to-transparent  h-px"/>
                    </button>
                </Link>

...
export function CardDemo({className, title, des}: { className?: string, title?: string, des?: string }) {
    return (
...
const Skeleton = () => {
    ...
    return (
        <div className=" w-full lg:w-full overflow-hidden h-full relative flex items-center justify-center">
...
export const Card = ({
    ...
    return (
        <div
            className={cn(
                "max-w-sm w-full mx-auto  rounded-xl  group",
                className
            )}
        >
            {children}
...
export const CardTitle = ({
    ...
    return (
        <h3
            className={cn(
                "text-lg font-semibold  text-white flex justify-center items-center",
                className
            )}
        >
            {children}
...
export const CardDescription = ({
    ...
    return (
        <p
            className={cn(
                "text-sm font-normal text-neutral-400 flex justify-center items-center w-full ",
                className
            )}
        >
            {children}
...
const Container = ({
    ...
    return (
        <div
            className={cn(
                `h-16 w-16 rounded-full flex text-center items-center justify-center
